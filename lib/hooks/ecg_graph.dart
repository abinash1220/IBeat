...
class GradientLineGraphView2 extends StatefulWidget {
  final double max;
  final double min;
  final double value;
...
class _LineGraphViewState extends State<GradientLineGraphView2>
...
class _LineGraphViewRenderBox extends RenderBox {
  ...
  Future<void> paint(PaintingContext context, Offset offset) async {
    ...
    canvas.drawCircle(pointOffset, 4, Paint()..color = Colors.red);
